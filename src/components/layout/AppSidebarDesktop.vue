      ...
      <router-link to="/joueurs" class="sidebar-link" active-class="sidebar-link-active">
        ...
        <router-link to="/admin/rapports" class="sidebar-link" active-class="sidebar-link-active">
          ...
          <span>Rapports</span>
                ...
                <router-link to="/documentation" class="sidebar-link" active-class="sidebar-link-active">
...
import {
  ...
  Receipt, BarChart3, Settings, UserCog, LogOut, PlayCircle, CreditCard, MessageSquare, Moon, Sun, Bug, BookOpen
...
const isDebug = computed(() => auth.isAuthenticated && auth.isAdmin)
