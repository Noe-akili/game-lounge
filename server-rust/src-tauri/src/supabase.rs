...
CREATE TABLE IF NOT EXISTS "sessions_jeu" (id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, console_id BIGINT, joueur_id BIGINT, jeu_id BIGINT, employe_id BIGINT, tarif_id BIGINT, debut TEXT, fin TEXT, duree_minutes INTEGER, duree_allouee INTEGER DEFAULT 60, montant INTEGER, tarif_prix INTEGER, jetons_gagnes INTEGER DEFAULT 0, statut TEXT, created_at TEXT, deleted INTEGER DEFAULT 0);
