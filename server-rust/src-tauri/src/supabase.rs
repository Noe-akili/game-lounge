...
#[cfg(feature = "supabase-sync")]
const SUPABASE_CONNECT_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(12);
#[cfg(feature = "supabase-sync")]
const SUPABASE_QUERY_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(12);
